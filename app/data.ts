...
export const projects: ProjectItem[] = [
  ...
  },
  {
    ...
    category: "sites",
    featured: true,
    title: "Chosen Burger — Landing Page Completa",
    description: "Landing page para hamburgueria com mascote jacaré: cardápio interativo com carrinho, cupons de desconto, integração iFood/99Food/WhatsApp e checkout completo.",
    link: "https://chosen-burger.vercel.app",
    tags: ["Next.js", "Food", "Carrinho", "WhatsApp", "Responsivo"],
    image: "/preview-chosen-burger.png",
  },
  {
    id: "techfix",
    category: "sites",
    ...
    description: "Landing page completa para assistência técnica: serviços de conserto, venda de celulares novos/seminovos, sistema de trocas, acessórios e formulário de contato via WhatsApp.",
    link: "/projetos/techfix",
    tags: ["Next.js", "Assistência Técnica", "Responsivo", "WhatsApp"],
    image: "/preview-techfix.png",
  },
  {
