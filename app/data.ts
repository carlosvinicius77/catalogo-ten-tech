...
export const projects: ProjectItem[] = [
  ...
  },
  {
    ...
    description: "Landing page jurídica minimalista com navy e dourado, áreas de atuação, advogados, resultados e formulário de consulta.",
    link: "/projetos/juridico",
    tags: ["Next.js", "Landing Page", "Jurídico"],
    image: "/preview-juridico.png",
  },
  {
    id: "imoveis",
    category: "sites",
    title: "Élite Imóveis — Imobiliária",
    description: "Landing page premium dark com glassmorphism, cards de imóveis, perfis de corretores e formulário de visita.",
    link: "/projetos/imoveis",
    tags: ["Next.js", "Glassmorphism", "Imóveis"],
    image: "/preview-imoveis.png",
  },
  {
    id: "viagens",
    category: "sites",
    title: "AuroraTravel — Agência de Viagens",
    description: "Landing page vibrante com aurora gradients, destinos, calculadora de pacotes, depoimentos e CTA de planejamento.",
    link: "/projetos/viagens",
    tags: ["Next.js", "Travel", "Aurora UI"],
    image: "/preview-viagens.png",
  },
  {
    id: "fitness",
    category: "sites",
